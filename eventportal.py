...
# The code is going to look for the event in the **Portal Catalog**. This catalog is generated through the .xml file **events.xml** with the script **Read_XML_from_Mars**.
#
